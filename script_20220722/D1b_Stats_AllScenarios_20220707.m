...
% load data
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\REFprocesses.mat',  'REFmean', 'varname_basinaverage_all')
varname_REF = varname_basinaverage_all;
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\ICE1processes.mat', 'ICE1mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\ICE2processes.mat', 'ICE2mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\ICE3processes.mat', 'ICE3mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\SUR1processes.mat', 'SUR1mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\SUR2processes.mat', 'SUR2mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\SUR3processes.mat', 'SUR3mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\SUB1processes.mat', 'SUB1mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\SUB2processes.mat', 'SUB2mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\SUB3processes.mat', 'SUB3mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\VEG1processes.mat', 'VEG1mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\VEG2processes.mat', 'VEG2mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\VEG3processes.mat', 'VEG3mean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\DRYprocesses.mat', 'DRYmean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\WETprocesses.mat',  'WETmean')
load('D:\5_FuturePeyto\crhm\C_Scenarios\output\AnnualAverages\ICE1processes.mat', 'varname_basinaverage_all')

load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\P1processes.mat', 'P1mean' , 'varname_basinaverage_all')
 varnameMETSIM= varname_basinaverage_all;
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\P_1processes.mat', 'P_1mean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\T2processes.mat', 'T2mean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\P_2processes.mat', 'P_2mean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\CWprocesses.mat', 'CWmean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\T1processes.mat', 'T1mean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\T_1processes.mat', 'T_1mean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\P2processes.mat', 'P2mean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\CDprocesses.mat', 'CDmean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\WDprocesses.mat', 'WDmean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\WWprocesses.mat', 'WWmean')
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\T_2processes.mat', 'T_2mean')

load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\PGWprocesses.mat', 'PGWmean')
...
lab_processes = {'Ice 0%','Ice 6%','Ice 9%',...
        'No Surf','Lake','Pond',...
        'Sub x0.5','Sub x5','Sub x10', ...
        'Veg <1%','Veg 5%','Veg 15%',...
        'Bare', 'Lush', ...
        strcat('T -2',deg_sign,'C'), strcat('T -2',deg_sign,'C'), strcat('T +1',deg_sign,'C'), strcat('T +2',deg_sign,'C'),...
        'P-20%', 'P-10%', 'P+10%', 'P+20%',...
...
%^
%%
figname ='Stats_ChangeFromPGW_Basinflow_Processes_forLandscape_20220708';
saveas (gcf, strcat('D:\5_FuturePeyto\fig\D1b\', figname, '.pdf'))
saveas (gcf, strcat('D:\5_FuturePeyto\fig\D1b\', figname, '.png'))
savefig(gcf, strcat('D:\5_FuturePeyto\fig\D1b\', figname))
...
load('D:\5_FuturePeyto\crhm\D_MetSim\output\AnnualAverages\PGWprocesses.mat', 'PGWmean', 'varname_basinaverage_all')
